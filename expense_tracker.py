...
Thank you for providing the script! I understand that new keywords like lambda, map, and filter may be unfamiliar, but I'm confident I can explain everything clearly without needing further clarification.

Here’s the explanation for each part of the script, with detailed comments directly in the code:
